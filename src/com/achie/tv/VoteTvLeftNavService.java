...
public class VoteTvLeftNavService {
    ...
    public static LeftNavBar getLeftNavBar(Context context) {
        ...
        bar.addTab(bar.newTab().setText(R.string.shows).setIcon(R.drawable.tv_show)
                .setTabListener(showTabListener), false);
    ...
    private static LeftNavBar.TabListener showTabListener = new LeftNavBar.TabListener() {
        public void onTabSelected(Tab tab, FragmentTransaction ft) {
            Intent intent = new Intent();
            intent.setClass(mContext, RealityShowActivity.class);
